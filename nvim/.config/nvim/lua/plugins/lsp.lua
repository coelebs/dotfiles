    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map("gh", ":find %:t:r.*<CR>", '[G]oto [H]eader')

          map("K", vim.lsp.buf.hover, "Show info")
          map("<C-k>", vim.lsp.buf.signature_help, "Show info in insert mode", "i")
      ...
      local servers = {
        ...
        lua_ls = {
          -- Mason binaries are not compatible with NixOS's dynamic linker.
